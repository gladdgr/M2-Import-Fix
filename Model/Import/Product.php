...
namespace Gladd\ImportFix\Model\Import;
...
class Product extends MagentoProduct
{
     ...
     * @param MagentoProduct $optionFactory
     * @param \Magento\Eav\Model\ResourceModel\Entity\Attribute\Set\CollectionFactory $setColFactory
     * @param MagentoProduct $productTypeFactory
     ...
     * @param MagentoProduct $storeResolver
     * @param MagentoProduct $skuProcessor
     * @param MagentoProduct $categoryProcessor
     * @param MagentoProduct $validator
     * @param ObjectRelationProcessor $objectRelationProcessor
     * @param TransactionManagerInterface $transactionManager
     * @param MagentoProduct $taxClassProcessor
